...
# 🗳️ Vote D-21 - Live Demo

## 🌐 Try it Now!

🚀 **Live Application**: [https://frontend-54kls5lho-serge92s-projects.vercel.app/](https://frontend-54kls5lho-serge92s-projects.vercel.app/)

### Quick Info
- **Program ID**: `7qsdAz3ta9gg3eikuzQuJMj928zFnPUB8C4rb42pr6RN`
- **Network**: Solana Devnet
- **Frontend**: Deployed on Vercel
- 🔍 [View Program on Explorer](https://explorer.solana.com/address/7qsdAz3ta9gg3eikuzQuJMj928zFnPUB8C4rb42pr6RN?cluster=devnet)

### How to Use
1. Open the live app above
2. Connect Phantom Wallet (set to Devnet)
3. Get devnet SOL using the built-in button
4. Initialize your voter account
5. Vote for 2 candidates (Alice, Bob, Charlie, or Diana)

### Project Documentation
- 📖 [Program README](./anchor_project/README.md) - Detailed program architecture
- 🌐 [Frontend README](./frontend/README.md) - Frontend setup and features
- 🚀 [Devnet Deployment](./DEVNET_DEPLOYMENT.md) - Deployment information
- 📋 [Vercel Deployment Guide](./VERCEL_DEPLOYMENT.md) - How to deploy
